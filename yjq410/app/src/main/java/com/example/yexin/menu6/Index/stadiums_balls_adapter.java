...
public class stadiums_balls_adapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null) {
            ...
            holder.stadiums_logo=(ImageView) convertView.findViewById(R.id.stadiums_logo);
            ...
            holder.btn_order.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                    ...
                    //Intent intent=new Intent(mContext,StadiumMainActivity.class);
        ...
        if(mData.get(position).getBallclub_ballname().equals("羽毛球")){
            holder.stadiums_logo.setImageDrawable (convertView.getResources().getDrawable(R.drawable.icon_badminton));
           // ball_collect.setImageDrawable (getResources().getDrawable(R.drawable.likeis));
        }else if(mData.get(position).getBallclub_ballname().equals("篮球")){
            holder.stadiums_logo.setImageDrawable (convertView.getResources().getDrawable(R.drawable.icon_basketball2));
        }else if(mData.get(position).getBallclub_ballname().equals("足球")){
            holder.stadiums_logo.setImageDrawable (convertView.getResources().getDrawable(R.drawable.icon_football));
        }else if(mData.get(position).getBallclub_ballname().equals("网球")){
            holder.stadiums_logo.setImageDrawable (convertView.getResources().getDrawable(R.drawable.icon_tenn));
        }
        return convertView;
