...
import com.example.yexin.menu6.BallCludInfoShow.StadiumMainActivity;
...
public class Payfaceture extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // String  date=intent.getStringExtra("date");//接受的值
        ...
        String SystemTime=GetSystemTime.GetSystemTime(StadiumMainActivity.TimeStatus);
       ...
       // Log.e("timeday","day:"+ StadiumMainActivity.TimeStatus);
        ...
        sure.setText("确认支付 Ұ "+jiage1.replaceAll("￥", ""));
        //选择支付方式
...
//        jiage=(TextView)findViewById(R.id.jiage);
        changguan=(TextView)findViewById(R.id.tv_game_name);
        xiangmu=(TextView)findViewById(R.id.tv_game_object);
        riqi=(TextView)findViewById(R.id.tv_game_date);
        changdi=(TextView)findViewById(R.id.tv_game_place);
        sure=(Button)findViewById(R.id.sure);
        //alipay = (RadioButton)findViewById(R.id.alipay);
        zfb = (RadioButton)findViewById(R.id.rb_zfb);
        weChat = (RadioButton)findViewById(R.id.rb_weChat);
